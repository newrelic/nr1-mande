  ...
  metrics: [
    {
      ...
      detailConfig: [
        ...
        {
          nrql: `SELECT average(timeSinceLoad) as 'Time To Player Ready (Average)' FROM PageAction, MobileVideo, RokuVideo WHERE actionName = 'PLAYER_READY' FACET session `,
            columnStart: 1,
          columnEnd: 6,
          chartSize: 'medium',
          chartType: 'bar',
    ...
    },
    {
      ...
      detailConfig: [
        ...
        {
          nrql: `SELECT histogram(timeSinceRequested/1000, width: 15, buckets: 50) FROM PageAction, MobileVideo, RokuVideo WHERE actionName = 'CONTENT_START' FACET city `,
          columnStart: 7,
          columnEnd: 12,
          chartSize: 'large',
          chartType: 'heatmap',
