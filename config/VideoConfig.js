  ...
  metrics: [
    {
      ...
      detailConfig: [
        {
          nrql: `SELECT (filter(uniqueCount(viewId), WHERE timeSinceLoad > 10)/count(*)) * 100 as '% Impact' FROM PageAction, MobileVideo, RokuVideo WHERE actionName = 'PLAYER_READY'`,
          columnStart: 1,
          columnEnd: 4,
          chartSize: 'small',
          chartType: 'billboard',
        ...
        },
        {
          ...
          chartSize: 'small',
          chartType: 'bar',
          title: 'Average Player Ready Time by View (Click for details)',
          useSince: true,
          click: 'openSession',
        },
        {
